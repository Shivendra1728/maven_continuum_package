...
public final class PortalConstants {
	...
	public static final String CREDITED_CLOSED = "Credited Closed";
	public static final String CREDITED_OPEN = "Credited Open";
...
//	public static final String EMAIL_RECIPIENT = "priyanshi.porwal@bytesfarms.com";
	public static final String EMAIL_SUBJECT_PREFIX = "Continuum - Your Return Order";
	...
	public static final String NOTE_STATUS_CUSTOMER = "RMA Note: ";
