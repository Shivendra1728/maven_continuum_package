...
public class ReturnOrderItemController {
	...
	public String updateReturnOrderItem(@RequestParam Long id, @RequestParam String rmaNo,@RequestParam String updateBy,
			@RequestBody ReturnOrderItemDTO updatedItem) {
		return returnOrderItemService.updateReturnOrderItem(id, rmaNo,updateBy, updatedItem);
	}

	@PutMapping("/update/note")
	public String updateNote(@RequestParam long lineItemId, @RequestParam Long assignToId, @RequestParam String rmaNo,@RequestParam String updateBy,
