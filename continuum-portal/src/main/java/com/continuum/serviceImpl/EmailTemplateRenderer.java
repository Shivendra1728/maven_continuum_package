...
//			+ "																	<p style=\"margin: 0; word-break: break-word;\"><span>&nbsp;Your return order reference number is:&nbsp;<span>${rma_order_no}</span></span></p>\r\n"
	...
	private static final String VENDER_LINE_ITEM_STATUS = "<html xmlns:v=\"urn:schemas-microsoft-com:vml\" xmlns:o=\"urn:schemas-microsoft-com:office:office\" lang=\"en\">\r\n"
			...
			+ "															<td class=\"pad\" style=\"padding-bottom:10px;padding-left:40px;padding-right:40px;\">\r\n"
			+ "																<div style=\"color:#052D3D;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;font-size:21px;line-height:120%;text-align:center;mso-line-height-alt:25.2px;\">\r\n"
			+ "																	<p style=\"margin: 0; word-break: break-word;\"> ${AssignedUser} has assigned this ${partNumber} line item with ${vendorName}  </p>\r\n"
			+ "																	<br>\r\n"
			+ "																	<p style=\"margin: 0; word-break: break-word;\">Current Status of Line Item is ${LineItemStatus}.</p>\r\n"
			+ "																	<p style=\"margin: 0; word-break: break-word;\">Please check and follow up on before ${date}</p>\r\n"
			+ "																</div>\r\n"
			+ "															</td>\r\n"
			+ "														</tr>\r\n"
