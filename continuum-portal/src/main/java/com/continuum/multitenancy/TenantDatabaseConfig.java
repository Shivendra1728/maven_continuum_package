...
@EnableJpaRepositories(basePackages = { "com.continuum.tenant.repos.repositories", "com.continuum.tenant.service",
		"com.continuum.serviceImpl" }, entityManagerFactoryRef = "entityManagerFactory", transactionManagerRef = "transactionManager")
public class TenantDatabaseConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(
		...
		emfBean.setPackagesToScan(
				new String[] { "com.continuum.tenant.repos.repositories", "com.continuum.tenant.repos.entity" });
