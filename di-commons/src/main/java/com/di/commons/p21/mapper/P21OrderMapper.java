...
public class P21OrderMapper {
	...
	public List<OrderDTO> convertP21OrderObjectToOrderDTO(String order) throws JsonMappingException, JsonProcessingException, ParseException {
			...
			for (P21OrderData p21OrderData : p21OrderDataList) {
				...
				//orderDTO.setRequestedDate(correctrequestedDate);
					...
					orderDTO.getShipTo().setAddressId(p21OrderData.getAddress_id());
